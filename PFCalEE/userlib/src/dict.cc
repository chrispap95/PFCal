//
// File generated by rootcint at Sun Dec  3 17:23:11 2017
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HGCSSSimHit*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HGCSSSimHit", ::HGCSSSimHit::Class_Version(), "./include/HGCSSSimHit.hh", 26,
...
namespace ROOT {
   void HGCSSSimpleHit_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void *new_HGCSSSimpleHit(void *p = 0);
   static void *newArray_HGCSSSimpleHit(Long_t size, void *p);
   static void delete_HGCSSSimpleHit(void *p);
   static void deleteArray_HGCSSSimpleHit(void *p);
   static void destruct_HGCSSSimpleHit(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HGCSSSimpleHit*)
   {
      ::HGCSSSimpleHit *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::HGCSSSimpleHit >(0);
      static ::ROOT::TGenericClassInfo 
         instance("HGCSSSimpleHit", ::HGCSSSimpleHit::Class_Version(), "./include/HGCSSSimpleHit.hh", 11,
                  typeid(::HGCSSSimpleHit), DefineBehavior(ptr, ptr),
                  &::HGCSSSimpleHit::Dictionary, isa_proxy, 4,
                  sizeof(::HGCSSSimpleHit) );
      instance.SetNew(&new_HGCSSSimpleHit);
      instance.SetNewArray(&newArray_HGCSSSimpleHit);
      instance.SetDelete(&delete_HGCSSSimpleHit);
      instance.SetDeleteArray(&deleteArray_HGCSSSimpleHit);
      instance.SetDestructor(&destruct_HGCSSSimpleHit);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::HGCSSSimpleHit*)
   {
      return GenerateInitInstanceLocal((::HGCSSSimpleHit*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::HGCSSSimpleHit*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
TClass *HGCSSSimpleHit::fgIsA = 0;  // static to hold class pointer

//______________________________________________________________________________
const char *HGCSSSimpleHit::Class_Name()
{
   return "HGCSSSimpleHit";
}

//______________________________________________________________________________
const char *HGCSSSimpleHit::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::HGCSSSimpleHit*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int HGCSSSimpleHit::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::HGCSSSimpleHit*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void HGCSSSimpleHit::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSSimpleHit*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *HGCSSSimpleHit::Class()
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::HGCSSSimpleHit*)0x0)->GetClass();
   return fgIsA;
}
...
void HGCSSMipHit::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "neigh_e_samelayer_[7]", neigh_e_samelayer_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "neigh_e_prevlayer_[7]", neigh_e_prevlayer_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "neigh_e_nextlayer_[7]", neigh_e_nextlayer_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "neigh_e_prev2layer_[7]", neigh_e_prev2layer_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "neigh_e_next2layer_[7]", neigh_e_next2layer_);
...
//______________________________________________________________________________
void HGCSSSimpleHit::Streamer(TBuffer &R__b)
{
   // Stream an object of class HGCSSSimpleHit.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(HGCSSSimpleHit::Class(),this);
   } else {
      R__b.WriteClassBuffer(HGCSSSimpleHit::Class(),this);
   }
}

//______________________________________________________________________________
void HGCSSSimpleHit::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class HGCSSSimpleHit.
      TClass *R__cl = ::HGCSSSimpleHit::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "e_", &e_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "l_", &l_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "x_", &x_);
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_HGCSSSimpleHit(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) ::HGCSSSimpleHit : new ::HGCSSSimpleHit;
   }
   static void *newArray_HGCSSSimpleHit(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) ::HGCSSSimpleHit[nElements] : new ::HGCSSSimpleHit[nElements];
   }
   // Wrapper around operator delete
   static void delete_HGCSSSimpleHit(void *p) {
      delete ((::HGCSSSimpleHit*)p);
   }
   static void deleteArray_HGCSSSimpleHit(void *p) {
      delete [] ((::HGCSSSimpleHit*)p);
   }
   static void destruct_HGCSSSimpleHit(void *p) {
      typedef ::HGCSSSimpleHit current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::HGCSSSimpleHit
...
namespace ROOT {
   void vectorlEHGCSSSimpleHitgR_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void vectorlEHGCSSSimpleHitgR_Dictionary();
   static void *new_vectorlEHGCSSSimpleHitgR(void *p = 0);
   static void *newArray_vectorlEHGCSSSimpleHitgR(Long_t size, void *p);
   static void delete_vectorlEHGCSSSimpleHitgR(void *p);
   static void deleteArray_vectorlEHGCSSSimpleHitgR(void *p);
   static void destruct_vectorlEHGCSSSimpleHitgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<HGCSSSimpleHit>*)
   {
      vector<HGCSSSimpleHit> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<HGCSSSimpleHit>),0);
      static ::ROOT::TGenericClassInfo 
         instance("vector<HGCSSSimpleHit>", -2, "prec_stl/vector", 49,
                  typeid(vector<HGCSSSimpleHit>), DefineBehavior(ptr, ptr),
                  0, &vectorlEHGCSSSimpleHitgR_Dictionary, isa_proxy, 4,
                  sizeof(vector<HGCSSSimpleHit>) );
      instance.SetNew(&new_vectorlEHGCSSSimpleHitgR);
      instance.SetNewArray(&newArray_vectorlEHGCSSSimpleHitgR);
      instance.SetDelete(&delete_vectorlEHGCSSSimpleHitgR);
      instance.SetDeleteArray(&deleteArray_vectorlEHGCSSSimpleHitgR);
      instance.SetDestructor(&destruct_vectorlEHGCSSSimpleHitgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<HGCSSSimpleHit> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const vector<HGCSSSimpleHit>*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static void vectorlEHGCSSSimpleHitgR_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const vector<HGCSSSimpleHit>*)0x0)->GetClass();
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlEHGCSSSimpleHitgR(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<HGCSSSimpleHit> : new vector<HGCSSSimpleHit>;
   }
   static void *newArray_vectorlEHGCSSSimpleHitgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) vector<HGCSSSimpleHit>[nElements] : new vector<HGCSSSimpleHit>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEHGCSSSimpleHitgR(void *p) {
      delete ((vector<HGCSSSimpleHit>*)p);
   }
   static void deleteArray_vectorlEHGCSSSimpleHitgR(void *p) {
      delete [] ((vector<HGCSSSimpleHit>*)p);
   }
   static void destruct_vectorlEHGCSSSimpleHitgR(void *p) {
      typedef vector<HGCSSSimpleHit> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<HGCSSSimpleHit>
...
extern "C" void G__set_cpp_environmentdict() {
  ...
  G__add_compiledheader("include/HGCSSSimpleHit.hh");
...
/* HGCSSSimpleHit */
static int G__dict_669_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HGCSSSimpleHit* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new HGCSSSimpleHit[n];
     } else {
       p = new((void*) gvp) HGCSSSimpleHit[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new HGCSSSimpleHit;
     } else {
       p = new((void*) gvp) HGCSSSimpleHit;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSSimpleHit*) G__getstructoffset())->e());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSSimpleHit*) G__getstructoffset())->x());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSSimpleHit*) G__getstructoffset())->y());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((HGCSSSimpleHit*) G__getstructoffset())->z());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 104, (long) ((HGCSSSimpleHit*) G__getstructoffset())->l());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->setE(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->setx(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->sety(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->setz(*(double*) G__Doubleref(&libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->setLayer((const unsigned int) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) HGCSSSimpleHit::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSimpleHit::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) HGCSSSimpleHit::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      HGCSSSimpleHit::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const HGCSSSimpleHit*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->ShowMembers(*(TMemberInspector*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->Streamer(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((HGCSSSimpleHit*) G__getstructoffset())->StreamerNVirtual(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSimpleHit::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) HGCSSSimpleHit::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HGCSSSimpleHit::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_669_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) HGCSSSimpleHit::DeclFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__dict_669_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)

{
   HGCSSSimpleHit* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new HGCSSSimpleHit(*(HGCSSSimpleHit*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef HGCSSSimpleHit G__THGCSSSimpleHit;
static int G__dict_669_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (HGCSSSimpleHit*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((HGCSSSimpleHit*) (soff+(sizeof(HGCSSSimpleHit)*i)))->~G__THGCSSSimpleHit();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((HGCSSSimpleHit*) (soff))->~G__THGCSSSimpleHit();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
// automatic assignment operator
static int G__dict_669_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HGCSSSimpleHit* dest = (HGCSSSimpleHit*) G__getstructoffset();
   *dest = *(HGCSSSimpleHit*) libp->para[0].ref;
   const HGCSSSimpleHit& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
/* vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> > */
static int G__dict_671_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reference obj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->at((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__dict_671_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_reference obj = ((const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->at((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__dict_671_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator* pobj;
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator xobj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->begin();
         pobj = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
      }
...
static int G__dict_671_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator* pobj;
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator xobj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->end();
         pobj = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__dict_671_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator* pobj;
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator xobj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->rbegin();
         pobj = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
      }
...
static int G__dict_671_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator* pobj;
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator xobj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->rend();
         pobj = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__dict_671_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->size());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->max_size());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->resize((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->resize((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]), *((HGCSSSimpleHit*) G__int(libp->para[1])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->capacity());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->empty());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reference obj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->operator[]((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__dict_671_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_reference obj = ((const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->operator[]((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__dict_671_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >[n];
     } else {
       p = new((void*) gvp) vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >;
     } else {
       p = new((void*) gvp) vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
   case 2:
     //m: 2
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]), *(HGCSSSimpleHit*) libp->para[1].ref);
     } else {
       p = new((void*) gvp) vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]), *(HGCSSSimpleHit*) libp->para[1].ref);
     }
     break;
   case 1:
     //m: 1
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
     } else {
       p = new((void*) gvp) vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
     }
     break;
   }
   result7->obj.i = (long) p;
...
static int G__dict_671_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >(*(vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) libp->para[0].ref);
   } else {
     p = new((void*) gvp) vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >(*(vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) libp->para[0].ref);
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
...
static int G__dict_671_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >(*((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator*) G__int(libp->para[0])), *((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator*) G__int(libp->para[1])));
   } else {
     p = new((void*) gvp) vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >(*((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator*) G__int(libp->para[0])), *((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator*) G__int(libp->para[1])));
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
...
static int G__dict_671_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >& obj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->operator=(*(vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) libp->para[0].ref);
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__dict_671_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->reserve((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const HGCSSSimpleHit& obj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->front();
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__dict_671_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const HGCSSSimpleHit& obj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->back();
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__dict_671_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->push_back(*(HGCSSSimpleHit*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->swap(*(vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator* pobj;
         vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator xobj = ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->insert(*((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator*) G__int(libp->para[0])), *(HGCSSSimpleHit*) libp->para[1].ref);
         pobj = new vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__dict_671_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->insert(*((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator*) G__int(libp->para[0])), *((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator*) G__int(libp->para[1]))
, *((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator*) G__int(libp->para[2])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->insert(*((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator*) G__int(libp->para[0])), (vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type) G__int(libp->para[1])
, *(HGCSSSimpleHit*) libp->para[2].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->pop_back();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->erase(*((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->erase(*((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator*) G__int(libp->para[0])), *((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator*) G__int(libp->para[1])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_671_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) G__getstructoffset())->clear();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic destructor
typedef vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> > G__TvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR;
static int G__dict_671_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) (soff+(sizeof(vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >)*i)))->~G__TvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*) (soff))->~G__TvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
extern "C" void G__cpp_setup_typetabledict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<HGCSSSimpleHit>",117,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("value_type",117,G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit),0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("pointer",85,G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit),0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("const_pointer",85,G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit),256,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reference",117,G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit),1,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("const_reference",117,G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit),257,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("size_type",107,-1,0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("difference_type",108,-1,0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("const_iterator",117,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiterator),256,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("const_reverse_iterator",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__setnewtype(-1,NULL,0);
}
...
static void G__setup_memvarHGCSSMipHit(void) {
   ...
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"neigh_e_samelayer_[7]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"neigh_e_prevlayer_[7]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"neigh_e_nextlayer_[7]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"neigh_e_prev2layer_[7]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"neigh_e_next2layer_[7]=",0,(char*)NULL);
...
static void G__setup_memvarvectorlEHGCSSMipHitcOallocatorlEHGCSSMipHitgRsPgR(void) {
   ...
   /* HGCSSSimpleHit */
static void G__setup_memvarHGCSSSimpleHit(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit));
   { HGCSSSimpleHit *p; p=(HGCSSSimpleHit*)0x1000; if (p) { }
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"e_=",0,(char*)NULL);
   G__memvar_setup((void*)0,104,0,0,-1,-1,-1,4,"l_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"x_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,-1,-1,4,"y_=",0,(char*)NULL);
   ...
   /* vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> > */
static void G__setup_memvarvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   { vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> > *p; p=(vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >*)0x1000; if (p) { }
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncHGCSSSimpleHit(void) {
   /* HGCSSSimpleHit */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit));
   G__memfunc_setup("HGCSSSimpleHit",1287,G__dict_669_0_1, 105, G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("e",101,G__dict_669_0_2, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("x",120,G__dict_669_0_3, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("y",121,G__dict_669_0_4, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("z",122,G__dict_669_0_5, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("l",108,G__dict_669_0_6, 104, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setE",401,G__dict_669_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setx",452,G__dict_669_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("sety",453,G__dict_669_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setz",454,G__dict_669_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 11 - val", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setLayer",841,G__dict_669_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "h - - 10 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__dict_669_0_12, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HGCSSSimpleHit::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__dict_669_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSimpleHit::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__dict_669_0_14, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HGCSSSimpleHit::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__dict_669_0_15, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HGCSSSimpleHit::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__dict_669_0_16, 85, G__get_linked_tagnum(&G__dictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__dict_669_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__dict_669_0_18, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__dict_669_0_19, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__dict_669_0_20, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSimpleHit::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__dict_669_0_21, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSSimpleHit::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__dict_669_0_22, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HGCSSSimpleHit::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__dict_669_0_23, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HGCSSSimpleHit::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HGCSSSimpleHit", 1287, G__dict_669_0_24, (int) ('i'), G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), -1, 0, 1, 1, 1, 0, "u 'HGCSSSimpleHit' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HGCSSSimpleHit", 1413, G__dict_669_0_25, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_669_0_26, (int) ('u'), G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), -1, 1, 1, 1, 1, 0, "u 'HGCSSSimpleHit' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}

static void G__setup_memfuncvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR(void) {
   /* vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> > */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR));
   G__memfunc_setup("at",213,G__dict_671_0_1, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__dict_671_0_2, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__dict_671_0_3, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__dict_671_0_4, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__dict_671_0_5, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__dict_671_0_6, 117, G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR), G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__dict_671_0_7, 107, -1, G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__dict_671_0_8, 107, -1, G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_671_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__dict_671_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - sz u 'HGCSSSimpleHit' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__dict_671_0_11, 107, -1, G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__dict_671_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_671_0_13, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__dict_671_0_14, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), G__defined_typename("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >",4514,G__dict_671_0_15, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >",4514,G__dict_671_0_16, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - n u 'HGCSSSimpleHit' - 11 'HGCSSSimpleHit()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >",4514,G__dict_671_0_17, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >",4514,G__dict_671_0_18, 105, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator' 10 - first u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__dict_671_0_19, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__dict_671_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__dict_671_0_21, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__dict_671_0_22, 117, G__get_linked_tagnum(&G__dictLN_HGCSSSimpleHit), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__dict_671_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'HGCSSSimpleHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__dict_671_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_671_0_25, 117, G__get_linked_tagnum(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' - 0 - position u 'HGCSSSimpleHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_671_0_26, 121, -1, -1, 0, 3, 1, 1, 0, 
"u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' - 0 - position u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator' 10 - first "
"u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__dict_671_0_27, 121, -1, -1, 0, 3, 1, 1, 0, 
"u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' - 0 - position k - 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::size_type' 0 - n "
"u 'HGCSSSimpleHit' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pop_back",831,G__dict_671_0_28, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__dict_671_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__dict_671_0_30, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' - 0 - first u 'vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("clear",519,G__dict_671_0_31, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >", 4640, G__dict_671_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__dictLN_HGCSSSimpleHit = { "HGCSSSimpleHit" , 99 , -1 };
G__linked_taginfo G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR = { "vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >" , 99 , -1 };
G__linked_taginfo G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiterator = { "vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator" , 99 , -1 };
G__linked_taginfo G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtabledict() {
  ...
  G__dictLN_HGCSSSimpleHit.tagnum = -1 ;
  G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR.tagnum = -1 ;
  G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiterator.tagnum = -1 ;
  G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR.tagnum = -1 ;
}
...
extern "C" void G__cpp_setup_tagtabledict() {
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_HGCSSSimpleHit),sizeof(HGCSSSimpleHit),-1,263424,(char*)NULL,G__setup_memvarHGCSSSimpleHit,G__setup_memfuncHGCSSSimpleHit);
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR),sizeof(vector<HGCSSSimpleHit,allocator<HGCSSSimpleHit> >),-1,298752,(char*)NULL,G__setup_memvarvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR,G__setup_memfuncvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgR);
   G__get_linked_tagnum_fwd(&G__dictLN_vectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiterator);
   G__get_linked_tagnum_fwd(&G__dictLN_reverse_iteratorlEvectorlEHGCSSSimpleHitcOallocatorlEHGCSSSimpleHitgRsPgRcLcLiteratorgR);
}
